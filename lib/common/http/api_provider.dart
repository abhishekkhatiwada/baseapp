...
class ApiProvider {
  ...
  Future<dynamic> delete(String url,
    ...
    final DioClient dio = DioClient(baseUrl: baseUrl, userId: userId);
    dynamic responseJson;
    try {
      final Map<String, String> header = {
        'content-type': 'application/json',
