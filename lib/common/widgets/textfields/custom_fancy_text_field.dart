...
class FancyCustomTextField extends FormField<String> {
  FancyCustomTextField({
    super.key,
    this.controller,
    ...
    TextInputAction? textInputAction,
          ...
          builder: (FormFieldState<String> field) {
            final _FancyCustomTextFieldState state =
                field as _FancyCustomTextFieldState;
  ...
  FormFieldState<String> createState() {
    return _FancyCustomTextFieldState();
  }
}

class _FancyCustomTextFieldState extends FormFieldState<String> {
  ...
  @override
  FancyCustomTextField get widget => super.widget as FancyCustomTextField;
  ...
  @override
  void didUpdateWidget(FancyCustomTextField oldWidget) {
